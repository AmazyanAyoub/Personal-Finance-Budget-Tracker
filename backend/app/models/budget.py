...
class BudgetSplit(Base):
    ...
    freedom_funds_pct: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    )
    essentials_pct: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    )
    lifestyle_pct: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
    )
...
class EmergencyFundConfig(Base):
    ...
    target_cents: Mapped[int] = mapped_column(
        BigInteger,
        nullable=False,
        server_default="0",
    )
